    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Create(Employee emp)
        {
            ...
            try
            {
                if (ModelState.IsValid == true)
                {
                    ...
                    if (check == true)
                    {
                        TempData["InsertMessage"] = "Data has been insert succesfully";
                        ModelState.Clear();
        ...
        public ActionResult Edit(int id, Employee emp)
        {
            ...
            if (ModelState.IsValid == true)
            {
                ...
                if (check == true)
                {
                    TempData["UpdateMessage"] = "Data has been Update succesfully";
                    ModelState.Clear();
        ...
        public ActionResult Delete(int id, Employee emp)
        {
            ...
            if (check == true)
            {
                TempData["DeleteMessage"] = "Data has been Delete succesfully";
                return RedirectToAction("Index");
            }
            return View();
        }
