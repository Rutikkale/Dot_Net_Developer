<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CusotmeValidator.aspx.cs" Inherits="CustomeValidatorAnotherExp.CusotmeValidator" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="auto-style1">
               ...
               <asp:CustomValidator ID="CustomValidatorGender" runat="server" ErrorMessage="*Please select Gender" ForeColor="Red" OnServerValidate="ValidateGender" Display="Dynamic">*</asp:CustomValidator>
